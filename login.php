...
<div class="container-fluid">
	<div class="row">
		...
		<div id="box">
			<br>
			<h2 class="text-grey text-center">TEACHER LOGIN</h2>
			<hr>
			<form method="post" action="">
				<input type="text" name="username" class="form-control" placeholder="Enter Username:" required maxlength="40" data-toggle="popover" data-placement= bottom"><br>
...
$connect = connect_to_database();
	...
	if (isset($_POST['login_user'])) {
		...
		$password = $_POST['password'];
			$query = "SELECT * FROM Teacher_table WHERE username= '$username' AND password='$password'";
